...
class DhcpNetwork:
    ...
    def SendDhcpPacketTo(self, packet, _ip,_port):
        ...
        raw_packet = packet.EncodePacket()
...
#             return ~s & 0xffff
#         
#         udp_header = struct.pack("!HHHH", 67, 68, len(raw_packet)+8, 0)
#         # Update our checksum
#         chksum = checksum(udp_header+raw_packet)        
        udp_header = struct.pack("!HHHH", 67, 68, len(raw_packet)+8, 0)

        return self.dhcp_socket_send.sendto(udp_header+raw_packet,(_ip,_port))
