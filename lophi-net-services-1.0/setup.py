...
setup (name = 'LOPHI-Net-Services',
        version = '1.0',
        description = 'This contains the LO-PHI Network Services binaries and configuration files that includes the following services: DNS, DHCP/PXE, TFTP, and a LO-PHI Control service.',
